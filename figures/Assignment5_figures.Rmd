...
p4 <- p3 + labs(title = "<b> Total length of Siscowet Lake Trout </b><br> <span style = 'font-size:10pt'> <span style='color:#1f78b4'>Male</span> and <span style='color:#33a02c'>female</span> fish lengths were compared across four locations in Michigan waters of Lake Superior </span>") +
  theme(
